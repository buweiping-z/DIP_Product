...
import { Package, Box, Wrench, MapPin, ClipboardList, Truck, RotateCcw, ArrowLeftRight, ClipboardCheck, AlertTriangle, CheckCircle, User, Users, ArrowUpRight, Repeat, Bell } from 'lucide-react';
...
const menu = [
  ...
  { path: '/changeover', label: '途中切替', icon: Repeat },
  { path: '/call-material', label: '叫料管理', icon: Bell },
