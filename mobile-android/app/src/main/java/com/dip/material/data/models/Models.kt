...
data class UserInfo(
    val id: Int, val username: String, val roleCode: String?,
...
data class PageResult<T>(
    val total: Int, val page: Int, @SerializedName("page_size") val pageSize: Int,
    val items: List<T>
)
...
data class DashboardStats(
    ...
    @SerializedName("prep_rate") val prepRate: Double,
    @SerializedName("inventory_alerts") val inventoryAlerts: InventoryAlerts,
...
data class InventoryAlerts(@SerializedName("low_stock") val lowStock: Int, @SerializedName("out_of_stock") val outOfStock: Int)
...
data class PrepDetail(
    ...
    @SerializedName("line_id") val lineId: Int, val status: Int,
    @SerializedName("details") val details: List<PrepDetailItem>
)
...
data class PrepScanRequest(
    val barcode: String,
    @SerializedName("prep_detail_id") val prepDetailId: Int? = null
)

// ===== Refill =====
data class RefillRecord(
    val id: Int, @SerializedName("prep_order_id") val prepOrderId: Int,
    @SerializedName("prep_order_no") val prepOrderNo: String,
    @SerializedName("prep_detail_id") val prepDetailId: Int,
    @SerializedName("part_no") val partNo: String,
...
data class ReturnOrderItem(
    ...
    val items: List<ReturnDetailItem>?,
    @SerializedName("created_at") val createdAt: String?
)
data class ReturnDetailItem(
    val id: Int, @SerializedName("part_id") val partId: Int,
    @SerializedName("part_no") val partNo: String, val quantity: Double,
    @SerializedName("target_location_id") val targetLocationId: Int
)
data class ReturnScanRequest(
    val barcode: String,
    @SerializedName("target_location_id") val targetLocationId: Int
)

// ===== Shelving =====
data class ShelvingBatchItem(
    val id: Int, @SerializedName("batch_no") val batchNo: String,
    val status: Int, @SerializedName("confirmed_at") val confirmedAt: String?
)
data class ShelvingDetail(
    val id: Int, @SerializedName("batch_no") val batchNo: String,
    @SerializedName("target_location_id") val targetLocationId: Int,
    @SerializedName("operator_id") val operatorId: Int, val status: Int,
    val items: List<ShelvingDetailItem>?
)
data class ShelvingDetailItem(
    val id: Int, @SerializedName("part_id") val partId: Int,
    @SerializedName("part_no") val partNo: String, val quantity: Double
)
data class ShelvingScanRequest(
    val barcode: String, @SerializedName("batch_id") val batchId: Int
)

// ===== Substitute =====
data class SubstituteRecordItem(
    val id: Int, @SerializedName("original_part_id") val originalPartId: Int,
    ...
    val quantity: Double, val status: Int, @SerializedName("operator_id") val operatorId: Int,
    @SerializedName("created_at") val createdAt: String?
)
...
data class InventoryAvailable(
    val id: Int, @SerializedName("location_id") val locationId: Int,
